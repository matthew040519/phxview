...
<head>
  ...
  <!-- Animate CSS  -->
  <link rel="stylesheet" href="front_page/assets/css/animate.css">

  <!-- FontAwesome 4.3.0 Icons  -->
  <link rel="stylesheet" href="front_page/assets/css/font-awesome.min.css">

  <!-- et line font  -->
  <link rel="stylesheet" href="front_page/assets/css/et-line-font/style.css">

  <!-- BXslider CSS  -->
  <link rel="stylesheet" href="front_page/assets/css/bxslider/jquery.bxslider.css">

  <!-- Owl Carousel CSS Style -->
  <link rel="stylesheet" href="front_page/assets/css/owl-carousel/owl.carousel.css">
  <link rel="stylesheet" href="front_page/assets/css/owl-carousel/owl.theme.css">
  <link rel="stylesheet" href="front_page/assets/css/owl-carousel/owl.transitions.css">

  <!-- Magnific-Popup CSS Style -->
  <link rel="stylesheet" href="front_page/assets/css/magnific-popup/magnific-popup.css">
...
<body>
      ...
      <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navigation-nav">
           ...
           <a class="navbar-brand" href="#"><img src="front_page/assets/images/logo.png" alt=""></a>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-7 img-creative-left text-center animated out" data-animation="fadeInLeft" data-delay="0">
              <figure>
                <img src="front_page/assets/images/temp/cover.png" alt="">
              </figure>
            </div> <!-- End col-sm-8 -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-4 col-sm-2">
              <div class="client">
                <a href="#"><img src="front_page/assets/images/clients/client_1.png" alt=""></a>
              </div>
            </div> <!-- end col-xs-6 -->
            ...
            <div class="col-xs-4 col-sm-2">
              <div class="client">
                <a href="#"><img src="front_page/assets/images/clients/client_2.png" alt=""></a>
              </div>
            </div> <!-- end col-xs-6 -->
            ...
            <div class="col-xs-4 col-sm-2">
              <div class="client">
                <a href="#"><img src="front_page/assets/images/clients/client_3.png" alt=""></a>
              </div>
            </div> <!-- end col-xs-6 -->
            ...
            <div class="col-xs-4 col-sm-2">
              <div class="client">
                <a href="#"><img src="front_page/assets/images/clients/client_4.png" alt=""></a>
              </div>
            </div> <!-- end col-xs-6 -->
          ...
          <div class="form-wrapper">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <!-- form fields -->
                <form action="front_page/assets/php/contact.php.htm" method="post" name="contactform" id="contactform" class="animated out" data-animation="fadeInUp" data-delay="0">
  ...
  <script src="front_page/assets/js/jquery-1.11.3.min.js"></script>
  <script src="front_page/assets/js/bootstrap.min.js"></script>
  <script src="front_page/assets/js/bootstrap-hover-dropdown.min.js"></script>
  <script src="front_page/assets/js/jquery.appear.min.js"></script>
  <script src="front_page/assets/js/jquery.bxslider.min.js"></script>
  <script src="front_page/assets/js/jquery.owl.carousel.min.js"></script>
  <script src="front_page/assets/js/jquery.countTo.js"></script>
  <script src="front_page/assets/js/jquery.easing.1.3.js"></script>
  <script src="front_page/assets/js/jquery.imagesloaded.min.js"></script>
  <script src="front_page/assets/js/jquery.isotope.js"></script>
  <script src="front_page/assets/js/jquery.placeholder.js"></script>
  <script src="front_page/assets/js/jquery.smoothscroll.js"></script>
  <script src="front_page/assets/js/jquery.stellar.min.js"></script>
  <script src="front_page/assets/js/jquery.waypoints.js"></script>
  <script src="front_page/assets/js/jquery.fitvids.js"></script>
  <script src="front_page/assets/js/jquery.magnific-popup.min.js"></script>
  <script src="front_page/assets/js/jquery.ajaxchimp.min.js"></script>
  <script src="front_page/assets/js/jquery.countdown.js"></script>
  <script src="front_page/assets/js/jquery.navbar-scroll.js"></script>
  <script src="http://maps.google.com/maps/api/js?sensor=false"></script>
  <script src="front_page/assets/js/jquery.gmaps.js"></script>
